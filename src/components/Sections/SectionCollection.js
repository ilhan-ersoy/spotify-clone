...
export default function SectionCollection({item,type}){
    ...
    return (
        <>
            <div
                ...
                {/*<img src={item.image} className={'w-[8.428vw] rounded-lg mt-3'} alt=""/>*/}
                <div className={'w-[9.25rem] h-[9.25rem] rounded mt-3 bg-[#333333] shadow-2xl'}>
                    <MusicIcon/>
                </div>
                <button
                ...
                <span className={'flex flex-col items-start min-h-14 pb-8 pt-2 pl-3 w-40 text-m'}>
                        ...
                        <p className={'text-s text-gray-400 mt-1'}>- Ilhan Ersoy</p>
                    </span>
            </div>
        </>
    )
